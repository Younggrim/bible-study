...
BOOKS = {
    ...
    "songofsolomon": ("song-of-solomon", "Sgs", "Song of Solomon"),
    "isaiah": ("isaiah", "Isa", "Isaiah"),
    "jeremiah": ("jeremiah", "Jer", "Jeremiah"),
    "lamentations": ("lamentations", "Lam", "Lamentations"),
    "ezekiel": ("ezekiel", "Eze", "Ezekiel"),
    "daniel": ("daniel", "Dan", "Daniel"),
    "hosea": ("hosea", "Hsa", "Hosea"),
    "joel": ("joel", "Joe", "Joel"),
    "amos": ("amos", "Amo", "Amos"),
    ...
    "1corinthians": ("1-corinthians", "1Cr", "1 Corinthians"),
    "2corinthians": ("2-corinthians", "2Cr", "2 Corinthians"),
